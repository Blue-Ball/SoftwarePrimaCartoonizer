...
namespace Silverwiz.Expander
{
    ...
    public class OdcExpander : HeaderedContentControl
    {
        ...
        public static readonly DependencyProperty FocusImageProperty =
            DependencyProperty.Register("FocusImage", typeof(ImageSource), typeof(OdcExpander), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty ExpandAreaHeightProperty =
            DependencyProperty.Register("ExpandAreaHeight", typeof(double), typeof(OdcExpander), new UIPropertyMetadata((double)0.0));
        ...
        public static readonly DependencyProperty NotificationCountProperty =
            DependencyProperty.Register("NotificationCount", typeof(string), typeof(OdcExpander), new UIPropertyMetadata("0"));
        ...
        public static readonly DependencyProperty IsSelectedProperty =
            DependencyProperty.Register("IsSelected", typeof(bool), typeof(OdcExpander), new UIPropertyMetadata(false));
